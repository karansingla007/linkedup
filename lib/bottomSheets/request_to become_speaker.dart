...
class RequestToBecomeSpeaker extends StatelessWidget {
  final Map hostUser;

  const RequestToBecomeSpeaker({this.hostUser});
            ...
            child: Stack(
              children: <Widget>[
                Align(
                    ...
                    child: CircleImageWithBorder(hostUser['profilePicUrl'])),
                Align(
                    alignment: Alignment.topCenter,
                    child: Padding(
                      padding: const EdgeInsets.only(left: 120.0),
                      child: CircleImageWithBorder(
                        hostUser['profilePicUrl'],
                      ),
                    )),
              ],
            ),
